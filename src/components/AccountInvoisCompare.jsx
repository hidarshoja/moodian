...
export default function AccountInvoisCompare({invoiceData  , pageCount ,setPageCount , setLoading , loading , refresh , setRefresh , meta2}) {
...
AccountInvoisCompare.propTypes = {
