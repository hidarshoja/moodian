...
import TransactionModal from './TransactionModalCompare';
import AssignModal from "./AssignModalCompare";
...
export default function FactorInvoiceCompare({invoiceData, loading , refresh , setRefresh , setLoading , meta3 , pageCount3 ,setPageCount3}) {
        ...
        <tbody>
          ...
          {invoiceData.map((r, i) => (
            ...
            >
              ...
              <td className="px-4 text-center py-3 text-white/90 text-sm whitespace-nowrap">
                {r?.id}
              </td>
              <td className="px-4 text-center py-3 text-white/90 text-sm whitespace-nowrap">
              ...
              <td className="px-4 text-center py-3 text-white/90 text-sm whitespace-nowrap">
               ...
               <td className="px-4 text-center py-3 text-white/90 text-sm whitespace-nowrap">
                {Number(r?.sum_associated_purchases_amount).toLocaleString()}
              </td>
               <td className="px-4 flex items-center justify-center py-3 text-white/90 text-sm whitespace-nowrap">
               
                {Number(r?.sum_associated_purchases_amount) == 0 ? <IoCloseCircle className="text-red-500 w-5 h-5"/> : ""}
                {r?.tadis  <= Number(r?.sum_associated_purchases_amount) ?
                 <IoMdCheckmarkCircle className="text-green-500 w-5 h-5"/> :(Number(r?.sum_associated_purchases_amount) > 0  ? <IoMdAlert className="text-yellow-500 w-5 h-5"/> : "")
                  }
...
FactorInvoiceCompare.propTypes = {
