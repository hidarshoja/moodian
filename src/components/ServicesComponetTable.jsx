...
export default function ServicesComponetTable({
  records,
  onDelete,
  onEdit,
  onOpenKeySettings,
      ...
      <table className="min-w-full">
        <thead>
          <tr className="text-white/80 text-sm bg-white/10">
            <th className="text-right px-4 py-3 whitespace-nowrap">شناسه</th>
            ...
            <th className="text-right px-4 py-3 whitespace-nowrap">نرخ سایر مالیات و عوارض</th>
            <th className="text-right px-4 py-3 whitespace-nowrap">سایر وجوه قانونی</th>
            <th className="text-right px-4 py-3 whitespace-nowrap">نرخ سایر وجوه قانونی</th>
