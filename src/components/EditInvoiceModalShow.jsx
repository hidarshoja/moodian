...
export default function EditInvoiceModalShow({ isOpen, onClose, invoiceData  , customers , products }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur overflow-y-auto">
      ...
      >
        {/* Header */}
        <div className="bg-[#1A2035] text-white px-6 py-3 rounded-t-lg flex items-center justify-between mt-[840px] md:mt-[180px] lg:mt-0">
        نمایش فاکتور
...
EditInvoiceModalShow.propTypes = {
