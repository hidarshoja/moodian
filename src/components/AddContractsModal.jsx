...
export default function AddContractsModal({ isOpen, onClose }) {
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-3 border-b border-white/10 bg-[#0a0a22] rounded-t-2xl">
          <span className="text-white text-lg font-bold">قرارداد جدید</span>
        ...
        >
          ...
          <div>
            <label className="block mb-1 text-white text-sm">مشتری</label>
            <select
              name="customer"
              value={form.customer}
              onChange={handleChange}
          ...
          <div>
            <label className="block mb-1 text-white text-sm">شماره قرارداد پیمانکاری</label>
            <input
              name="contractNumber"
