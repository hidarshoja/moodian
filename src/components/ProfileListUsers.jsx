              ...
              <td className="p-2  text-center"></td>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-2">
                  ...
                  <button
                    ...
                    title="کلید"
                    className="p-1 md:p-2 rounded-lg bg-blue-500/10 text-blue-400 border border-blue-500/20 hover:bg-blue-500/15"
                  >
                    <GoKey className="w-4 md:w-5 h-4 md:h-5" />
                  </button>
                </div>
              </td>
            </tr>
