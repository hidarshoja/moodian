...
export default function AccountInvoisAll({invoiceData  , pageCount ,setPageCount , setLoading , loading , refresh , setRefresh , meta2}) {
...
.then((response) => {
   ...
   setLoading3(true);
axiosClient.get(`/invoices?page=${pageCount2}&f[sum_transactions] = <,tadis,${r.id}&f[type]=-1`)
.then((response) => {
 ...
 useEffect(() => {
  ...
  return (
    <div>
      <h1 className="text-white text-2xl font-bold mt-6">تعیین تکلیف شده های حساب</h1>
